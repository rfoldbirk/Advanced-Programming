...
public class Board extends Subject {
    ...
    // Setter metode + husk notifychange()
    ...
    public Space getNeighbour(@NotNull Space space, @NotNull Heading heading) {
        ...
        if (getSpace(x,y).getWalls().contains(heading.opposite())){
            return null;
        }
    ...
    public String getStatusMessage() {
        ...
        // TODO A6a: add the move count to the status message of the board √ done
        ...
        return "Player = " + getCurrentPlayer().getName() + ". Count: " + getCounter(); // vi tilføjer counteren her
    }
