...
public class AppController implements Observer {
    ...
    public void newGame() {
        ...
        if (result.isPresent()) {
            ...
            ChoiceDialog<String> boardDialog = new ChoiceDialog<>(BoardFactory.getInstance().getBoardNames().get(0),BoardFactory.getInstance().getBoardNames());
            ...
            if (resultBoard.isPresent()){
                Board board = BoardFactory.getInstance().createBoard(resultBoard.get());
